...
func InitDatabase(path string) error {
	...
	db.AutoMigrate(&DABlockNumber{}, &LicenseInfo{}, &LicensePurchaseHistory{}, &DelMEMOMintInfo{}, &DelMEMOTransferInfo{}, &RedeemInfo{}, &RewardWithdrawInfo{}, &NodeInfo{}, &NodeDailyDelegation{})
	GlobalDataBase = db
	return nil
}
